...
export interface CompletionItem {
	...
	short: string;
	/** BrandIcon glyph name, shown in the rail until the item is done. Monochrome by
	 * design: two dozen coloured emoji side by side read as noise, and vendors draw
	 * them at different weights so the row never looked like one set. */
	icon: string;
